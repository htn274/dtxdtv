...
public class GetPathFromLocation extends AsyncTask<String, Void, PolylineOptions> {
        ...
        private String API_KEY = "AIzaSyCOksSwBgJDQdw9BuQmRrVQYVv6b0rsYWw";
        private LatLng source, destination;
        private int lineColor;
        private DirectionPointListener resultCallback;

        public GetPathFromLocation(LatLng source, LatLng destination, int color, DirectionPointListener resultCallback) {
            this.source = source;
            ...
            try {
                ...
                try {
                    ...
                    for (int i = 0; i < routes.size(); i++) {
                        ...
                        lineOptions.width(8);
                        lineOptions.color(this.lineColor);
